...
Installs Talisman from GitHub release and adds it to the global PATH.
...
At the time of publishing, no tested distro has `talisman` in their pubic repo; all installations will be a pull from
GitHub Release.
